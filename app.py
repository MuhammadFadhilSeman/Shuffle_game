...
QUESTIONS_ID = [
    ...
    "Cerita teman baik banget",
    "Pengalaman memalukan yg tak terlupakan",
    "Kejadian teraneh dalam hidup",
    "Kebandelan pas di sekolah",
    "Pernah di hukum Guru karena",
    "Pernah berantem karena",
    "Berantem tapi kocak",
    "Di omelin mama tapi ko lucu",
    "Kelakuan nyeleneh pas kecil",
    "Kebiasaan yg buruk",
    "Kangen ngapain",
    "Pernah ngerasa punya kekuatan super",
    "Keuntungan berteman dengan lo",
    "Sering lupa gimana",
    "Salah satu Keberuntungan dalam hidup",
    "Ngerasa dirugiin karena",
    "Paling seneng saat",
    "Benci dengan keadaan",
    "Rasanya pengen ngehilang dari bumi sebab malu karena",
    "Sederhana tapi bikin bahagia",
    "Ngerasa kuat saat",
    "Menyesal setelah ngelakuin",
    "Guru favorite+karena",
    "Kegiatan ter cape dalam hidup",
    "Motivasi yg berpengaruh dalam hidup",
    "Buang-buang waktu tapi asik",
    "Kemarahan ortu ter dahsyat",
    "Pengen banget rasanya",
    "Pernah salting gara-gara diliatin",
    "Paling ga bisa kalo",
    "Kejadian menegangkan dalam hidup",
    "Hampir mati karena",
    "Kegiatan favorit",
    "Abis bangun tidur ngapain",
    "plan untuk masa depan",
    "Ngerasa paling bisa di bidang",
    "Kelakuan terjahat",
    "Tuduhan yg kocak",
    "Suka mikirin apa",
    ...
    "Tiru gaya tiktok tapi tanpa lagu apapun!",
    ...
    "Design ulang bendera Indonesia kalao di jajah Afrika",
